...
class QwenImageEditInpaintPipelineParameters(DiffusionPipelineTypePipelineParameters):
    PIPELINE_NAME: ClassVar[str] = "QwenImageEditInpaintPipeline"
    ...
    def build_pipeline(self) -> diffusers.QwenImageEditInpaintPipeline:
        import diffusers  # type: ignore[reportMissingImports]
        ...
        return diffusers.QwenImageEditInpaintPipeline.from_pretrained(
