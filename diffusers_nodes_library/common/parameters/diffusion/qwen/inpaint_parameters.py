...
class QwenInpaintPipelineParameters(DiffusionPipelineTypePipelineParameters):
    PIPELINE_NAME: ClassVar[str] = "QwenImageInpaintPipeline"
    ...
    def build_pipeline(self) -> diffusers.QwenImageInpaintPipeline:
        import diffusers  # type: ignore[reportMissingImports]
        ...
        return diffusers.QwenImageInpaintPipeline.from_pretrained(
