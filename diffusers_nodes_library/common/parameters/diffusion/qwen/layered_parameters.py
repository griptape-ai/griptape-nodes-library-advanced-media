...
class QwenLayeredPipelineParameters(DiffusionPipelineTypePipelineParameters):
    PIPELINE_NAME: ClassVar[str] = "QwenImageLayeredPipeline"
    ...
    def build_pipeline(self) -> diffusers.QwenImageLayeredPipeline:
        import diffusers  # type: ignore[reportMissingImports]
        ...
        return diffusers.QwenImageLayeredPipeline.from_pretrained(
